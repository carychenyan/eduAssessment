(function () {
    ...
    UE.commands['scrawl'] = {
        queryCommandState: function () {
            return (browser.ie && browser.version <= 9) ? -1 : 0;
        }
    };
    ...
    */
    ...
    UE.plugins['video'] = function () {
        ...
        function creatInsertStr(url, width, height, align, toEmbed, addParagraph, toUpload) {
          ...
          '<embed allowscriptaccess="always" allowfullscreen="true" quality="high" bgcolor="#FFF" wmode="transparent" src="' + commonParams.dodoDevPath + '/statics/ckplayer/ckplayer.swf" flashvars="f=' + url + '&i=' + commonParams.dodoDevPath + '/statics/ckplayer/loading.jpg&d=' + commonParams.dodoDevPath + '/statics/ckplayer/loading.jpg&u=&l=' + commonParams.dodoDevPath + '/statics/ckplayer/loading.jpg&r=&t=5&y=&z=&e=2&v=80&p=0&h=3&q=&m=0&o=&w=&g=&j=&k=&n=&my_url=' + commonParams.dodoDevPath + '" width="' + width + '" height="' + height + '" name="ckplayer_a1" id="ckplayer_a1" align="middle" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer">';
            }
            else {
                a = !toEmbed ?
    (addParagraph ? ('<p ' + (align && align != "none" ? (align == "center" ? ' style="text-align:center;" ' : ' style="float:"' + align) : '') + '>') : '') +
    ...
    */
    ...
    (function () {
        ...
        Button.prototype = {
            ...
            getHtmlTpl: function () {
                var title = this.disabled ? "请使用IE10、chrome、firefox等以上版本使用涂鸦功能" : this.title;
