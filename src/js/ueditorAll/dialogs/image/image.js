    ...
    */
    function getAlbumImages() {
        ...
        function showImages(obj) {
            if (obj.type) {
                g("imageList").innerHTML = !obj.data.rows.length ? "&nbsp;&nbsp;" + lang.noUploadImage : "";
                //去除空格
                for (var k = 0; k < obj.data.rows.length; k++) {
                    var img = document.createElement("img");
                    ...
                    img.setAttribute(k < 35 ? "src" : "lazy_src", obj.data.rows[k].url);
                    img.setAttribute("data_ue_src", obj.data.rows[k].url);

                }
            }
        }
        $.ajaxJSONP(editor.options.getImages, null, showImages);
