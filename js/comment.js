...
jQuery.fn.extend({
    ...
    get_comment_list: function() {
        ...
        //ajax请求
        $.get(commonParams.dodoYanxiuPath + "/Comment/commentList", {
    ...
    get_comment_page_list: function() {
        $(this).die().live("click", function(e) {
            ...
            //ajax请求
            $.get(commonParams.dodoYanxiuPath + url, {
                'comment_type': comment_type,
                'comment_type_id': comment_type_id,
    ...
    add_comment: function() {
        $(this).die().live("click", function() {
            ...
            //ajax请求
            $.get(commonParams.dodoYanxiuPath + "/Comment/addComment", {
                'comment_type': comment_type,
                'comment_type_id': comment_type_id,
    ...
    delete_comment: function() {
        $(this).die().live("click", function() {
            ...
            var datas = '';
            //ajax请求
            $.get(commonParams.dodoYanxiuPath + "/Comment/deleteComment", {
