...
'<tr>' +
	...
	'<td>' +
	    '<div class="lcui_head">' +
			...
			'<tr>' +
			    '<td width="14"><a class="cui_pm" href="javascript:void(0);"><i class="icon_arrLeft"></i></a></td>' +
				'<td width="40"><input class="cui_im" maxlength="4" value=""/>月</td>' +
				'<td><a class="cui_nm" href="javascript:void(0);"><i class="icon_arrRight"></i></a></td>' +
				'<td width="14"><a class="cui_py" href="javascript:void(0);"><i class="icon_arrLeft"></i></a></td>' +
				'<td width="60"><input class="cui_iy" maxlength="4" value=""/>年</td>' +
				'<td width="9"><a class="cui_ny" href="javascript:void(0);"><i class="icon_arrRight"></i></a></td>' +
			'</tr>' +
			'</table>' +
